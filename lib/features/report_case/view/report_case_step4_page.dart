...
/// ===========================================================
/// REPORT CASE STEP 4 PAGE
/// Pantalla visual para el cuarto paso de reporte de caso.
/// Solo UI, preparada para conectar lógica posterior.
/// ===========================================================
class ReportCaseStep4Page extends StatefulWidget {
  final bool isInstitutionContext;

  const ReportCaseStep4Page({
    super.key,
    required this.isInstitutionContext,
  });
...
class _ReportCaseStep4PageState extends State<ReportCaseStep4Page> {
  ...
  String get _dynamicTitle {
    if (widget.isInstitutionContext) {
      return "Contexto institucional";
    }
    return "Contexto de la situación";
  }

  String get _stepTitle => "Paso 4: $_dynamicTitle";
                        ...
                        child: _PrimaryActionButton(
                          ...
                          onTap: () {
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (_) => const ReportCaseStep5Page(),
                              ),
                            );
                          },
                        ),
  ...
  Widget _buildDescriptionArea(double h) {
    return Container(
